...
[![CI](https://github.com/Unity-Billal-mesloub/flycheck/actions/workflows/test.yml/badge.svg)](https://github.com/Unity-Billal-mesloub/flycheck/actions/workflows/test.yml)
[![Docs](https://github.com/Unity-Billal-mesloub/flycheck/actions/workflows/docs.yml/badge.svg)](https://github.com/Unity-Billal-mesloub/flycheck/actions/workflows/docs.yml)
[![Lint Python](https://github.com/Unity-Billal-mesloub/flycheck/actions/workflows/lint-python.yml/badge.svg)](https://github.com/Unity-Billal-mesloub/flycheck/actions/workflows/lint-python.yml)
...
terms of the [Mit License][copying] as published by the Free
Software Foundation, either version 3 of the License, or (at your option) any
later version.

Flycheck is distributed in the hope that it will be useful, but WITHOUT ANY
WARRANTY; without even the implied warranty of MERCHANTABILITY or FITNESS FOR A
PARTICULAR PURPOSE.  See the [Mit License][copying] for more
details.

[COPYING]: https://github.com/Unity-Billal-mesloub/flycheck/blob/main/COPYING
[logo]: https://raw.githubusercontent.com/flycheck/flycheck/main/doc/_static/logo.png
...
[Issue Tracker]: https://github.com/Unity-Billal-mesloub/flycheck/issues
